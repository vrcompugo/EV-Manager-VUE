            ...
            <div v-if="!calculated.invalid_form">
              <div class="layout horizontal">
                ...
                <div style="position: relative;">
                  ...
                  <div class="settings-tooltip" :style="showSettingTooltip && 'display: block;'" v-if="$auth.user.bitrix_department.indexOf('AEV Vertrieb GmbH') < 0">
      ...
      <v-card>
        ...
        <v-card-text>
          ...
          <div v-if="pdf_contract_summary_part1_file_id">
            <div v-if="(new Date(quote_datetime.replace(' ', 'T'))) > (new Date()) - 60 * 60 * 1000 * 24 * 14">
