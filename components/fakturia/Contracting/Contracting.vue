<template>
  <div>
    ...
    Vertragsbeginn: {{ deal.activation_date | dateFormat }}<br>
    <br>
    <div v-if="deal.service_contract_number !== undefined && deal.service_contract_number !== null && deal.service_contract_number !== ''">
